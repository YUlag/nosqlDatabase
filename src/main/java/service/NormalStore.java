...
public class NormalStore implements Store {
    ...
    public void reloadIndex() {
        try {
            RandomAccessFile file = new RandomAccessFile(this.getFilePath(), RW_MODE);//随机读写文件
    ...
    public void set(String key, String value) {
        try {
            ...
            // 写table（wal）文件
            RandomAccessFileUtil.writeInt(this.getFilePath(), commandBytes.length);
            int pos = RandomAccessFileUtil.write(this.getFilePath(), commandBytes);
            // 保存到memTable
